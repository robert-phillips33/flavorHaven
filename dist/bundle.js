...
/* harmony import */ var _data_recipes_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12);
...
const findRecipePrice = (recipe) => {
  ...
  // let pricePerIngredient = [];
  // let accessRecipeIngredArray = recipe.ingredients.map((aIngredient) => {
  //   return aIngredient.quantity.amount;
  // });
  // // console.log('<><><>', accessRecipeIngredArray)
  // recipe.ingredients.forEach((ingredient) => {
  //   // console.log('L53-ish ingredient in forEach:', ingredient)
  //   let currentIngredient = ingredientsData.find((ingredients) => ingredients.id === recipe.ingredients.id);
  //   // console.log('L55-ish recipe ingredient price:', currentIngredient)
  //   let priceForThisIngredient = (currentIngredient.estimatedCostInCents * accessRecipeIngredArray);
  //   console.log('L57-ish price for ingredient in forEach:', accessRecipeIngredArray)
  //   pricePerIngredient.push(priceForThisIngredient);
  // })
  // // let initVal = 0;
  // let totalValue = pricePerIngredient.reduce((accumulatorVal, currentVal) => {
  //   return parseInt((accumulatorVal + currentVal) / 100);
  ...
  for (var i = 0; i < _data_recipes_js__WEBPACK_IMPORTED_MODULE_1__["default"].ingredients.length; i++){
    var currentIngredient = _data_ingredients_js__WEBPACK_IMPORTED_MODULE_0__["default"].find((ingredient) => ingredient.id === recipe.ingredients[i].id);
...
/* harmony import */ var _domUpdates__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(13);
